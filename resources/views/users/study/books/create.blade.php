...
<form action="{{route('users.study.books.insert')}}" method="post" class="max-w-sm mx-auto" enctype="multipart/form-data">
  ...
  <div class="mb-5">
    ...
    <input type="text"
      ...
      placeholder="{{ __('messages.book_title_placeholder') }}"
      required />
  </div>
  ...
  <div class="mb-5">
    <label for="book" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{{ __('messages.upload_book_label') }}</label>
    <input
      type="file"
      name="book"
      id="book"
  ...
  <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">{{ __('messages.add_button') }}</button>
</form>
